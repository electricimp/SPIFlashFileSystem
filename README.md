...
**To add this library to your project, add `#require "SPIFlashFileSystem.class.nut:1.0.3"`` to the top of your device code.**
...
#### imp003 and above
```squirrel
#require "SPIFlashFileSystem.class.nut:1.0.3"
